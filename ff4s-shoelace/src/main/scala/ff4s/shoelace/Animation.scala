...
/**
  ...
  * 
  * [[https://github.com/buntec/ff4s-shoelace/blob/master/ff4s-shoelace/src/main/scala/ff4s/shoelace/Animation.scala Animation.scala source code]]
  * 
  * [[https://shoelace.style/components/animation Shoelace Animation docs]]
  */
object Animation extends WebComponent {
  override val tagName: String = "sl-animation"
